...
public class RouteDrawerTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
    ...
    protected List<List<HashMap<String, String>>> doInBackground(String... jsonData) {
        ...
        try {
            ...
            com.wolfsoft.kcab.rota.DataRouteParser parser = new com.wolfsoft.kcab.rota.DataRouteParser();
    ...
    private void drawPolyLine(List<List<HashMap<String, String>>> result) {
        ...
        for (int i = 0; i < result.size(); i++) {
            ...
            lineOptions.width(6);
            routeColor = ContextCompat.getColor(DrawRouteMaps.getContext(), com.wolfsoft.kcab.R.color.colorRouteLine);
            if (routeColor == 0)
